...
│   ├── get_dragen_rna_outputs_from_portal_run_id_py/
...
- **SSM prefix**: `/orcabus/workflows/arriba-wgts-rna/`
- **Stack prefix**: `orca-arriba-wgts-rna`
- **Workflow name**: `arriba-wgts-rna`
- **Lambda runtime**: Python 3.14 on ARM64
- **Upstream workflow name**: `dragen-wgts-rna` (glue pattern dependency)
