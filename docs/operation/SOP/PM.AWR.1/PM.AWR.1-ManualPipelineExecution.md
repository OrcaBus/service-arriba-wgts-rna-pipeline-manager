...
This Pipeline Manager manages the execution of the ARRIBA WGTS RNA pipeline. Here we describe the SOP for manual execution of the pipeline.
...
- familiarise yourself with the script: [generate-WRU-draft.sh](./generate-WRU-draft.sh)
  ...
  - Set the engine parameters (if necessary) and library id(s) in the positional command-line arguments.
