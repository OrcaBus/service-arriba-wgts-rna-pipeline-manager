...
"""
Post schema validation for Arriba WGTS RNA workflows
...
def validate_inputs(
    ...
    # Alignment data — can be bamInput or cramInput
    alignment_data = inputs.get("alignmentData", {})
    data_uris.append(alignment_data.get("bamInput"))
    data_uris.append(alignment_data.get("cramInput"))

    # Reference files
    data_uris.append(inputs.get("referenceFasta"))
    data_uris.append(inputs.get("annotationGtf"))
    data_uris.append(inputs.get("cytobandsTsv"))
    data_uris.append(inputs.get("proteinDomainsGff3"))
    data_uris.append(inputs.get("blacklistTsv"))
    ...
    Input:
      {
        ...
        "data": {
          ...
          "inputs": {
            "sampleName": "...",
            "alignmentData": {"bamInput": "s3://..."} or {"cramInput": "s3://..."},
            "referenceFasta": "s3://...",
            "annotationGtf": "s3://...",
            "cytobandsTsv": "s3://...",
            "proteinDomainsGff3": "s3://...",
            "blacklistTsv": "s3://..."
          },
          "tags": { ... }
        }
